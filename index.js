        ...
        if (row === null) {
          ...
          switch (this.winner) {
            case 0: 
              ...
              break;
            case 1:
                document.write('<div role="dialog" aria-modal="true" aria-label="Resultat"><button>Fermer</button><h2>Le joueur 1 gagne</h2></div>') 
              break;
            case 2:
                document.write('<div role="dialog" aria-modal="true" aria-label="Resultat"><button>Fermer</button><h2>Le joueur 2 gagne</h2></div>  ')
              break;
          }
        }
      }
